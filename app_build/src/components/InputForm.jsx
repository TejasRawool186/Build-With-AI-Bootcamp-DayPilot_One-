      ...
      <form className="form-card" onSubmit={handleSubmit}>
        <div className="form-grid">
          <div className="form-group">
            <label className="form-label" htmlFor="input-name"><User size={16} color="var(--accent-blue)" /> Your Name</label>
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="input-city"><MapPin size={16} color="var(--accent-peach)" /> Your City</label>
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="input-email"><Mail size={16} color="var(--accent-lavender)" /> Email (optional)</label>
        ...
        <button id="generate-btn" className="generate-btn" type="submit" disabled={isLoading}>
          {isLoading ? (<><Loader2 size={20} className="spin-icon" /> Crafting Plan...</>) : (<><Sparkles size={20} /> Generate My Day Plan</>)}
        </button>
      </form>
    </div>
  )
